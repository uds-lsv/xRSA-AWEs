    ...
    for epoch_index in range(num_epochs):
        ...
        for batch_index, batch_dict in enumerate(batch_generator):
            ...
            reconstructed_signal, acoustic_embs = word_encoder(
                batch_dict['anchor_acoustic_word'], 
                batch_dict['positive_acoustic_word']
            )
            ...
            loss = MSE_loss(batch_dict['positive_acoustic_word'][:,:, 1:], reconstructed_signal[:,:, :-1])
        ...
        for batch_index, val_batch_dict in enumerate(batch_generator):
            ...
            # forward pass, get predictions and embeddings 
            reconstructed_signal, acoustic_embs = word_encoder(
                val_batch_dict['anchor_acoustic_word'], 
                val_batch_dict['positive_acoustic_word']
            )
            ...
            val_loss = MSE_loss(val_batch_dict['positive_acoustic_word'][:,:, 1:], reconstructed_signal[:,:, :-1])
